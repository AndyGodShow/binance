...
const RSS_SOURCES: RssSource[] = [
    ...
    {
        category: 'ai',
        url: buildGoogleNewsRssUrl('(OpenAI OR Anthropic OR Google AI OR Gemini OR DeepMind OR NVIDIA OR xAI OR Meta AI OR Llama OR "AI model" OR "AI chips" OR GPU OR "data center") when:1d'),
        source: 'Google News',
        tags: ['人工智能'],
    },
    {
